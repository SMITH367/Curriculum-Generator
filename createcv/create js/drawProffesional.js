...
profile.addEventListener("input",()=>{
    ...
    contProfile.innerHTML = ` <h3 class="center"> 
...
experience.addEventListener("input",()=>{
    ...
    contExperience.innerHTML = ` <h3 class="center"> 
...
education.addEventListener("input",()=>{
    ...
    contEducation.innerHTML = ` <h3 class="center">  <i class="fa fa-university" aria-hidden="true"></i> Educacion </h3> <p> ${value} <p>`
})